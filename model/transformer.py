...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.mh_self_attn = self.MultiHeadedSelfAttention(model_dim, num_heads)
        self.feed_fwd = self.VanillaNeuralNetwork(model_dim)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        embedded = embedded + self.mh_self_attn(self.layer_norm_1(embedded))
        embedded = embedded + self.feed_fwd(self.layer_norm_2(embedded))
